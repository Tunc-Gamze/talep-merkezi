...
async function api(req,res,url){
 ...
 if(method==='GET'&&route==='/api/requests'){const user=requireUser(req,res);if(!user)return;return send(res,200,{requests:db.prepare(requestSql+' ORDER BY r.id DESC').all()})}
